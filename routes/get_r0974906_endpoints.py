...
from queries import r0974906_queries as queries
import database
app = APIRouter()

@app.get("/flavours")
def get_flavours_table():
    flavours_query = queries.flavours_query
...
def get_holders_table():
    holders_query = queries.holders_query
...
def get_toppings_table():
    toppings_query = queries.toppings_query
